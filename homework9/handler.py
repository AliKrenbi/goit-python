...
from contactbook import contact_book
...
def add_handler(username: str, number: str):
    ...
    raise ValueError("Number already exist in contact book!")
...
def show_all_handler():
    ...
    formatted_contacts = "Number does not exists, yat!" if contacts == "" else contacts
